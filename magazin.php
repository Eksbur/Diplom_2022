...
<section id="banner">
<hr>
<h1><a href="magazin.html" id="logo">Магазин</a></h1>
<hr>
  <a class="btn" href="cart.php" >Корзина</a> <p>
  </p>
          <?php
            if (isset($_SESSION['message_key'])) {
                echo '<p class="msg"> ' . $_SESSION['message_key'] . ' </p>';
            }
...
$result = $connect->query('SELECT * FROM `game`'); // запрос на выборку
