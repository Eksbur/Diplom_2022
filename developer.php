...
$query = mysqli_query($connect, "SELECT * FROM developer WHERE id = '$id'");
...
$result = $connect->query("SELECT * FROM `game` where developer = '$id'"); // запрос на выборку
